             ...
             <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden sticky top-24">
                ...
                <nav className="flex flex-col p-2">
                  ...
                  >
                   ...
                   <a href="https://www.btl.gov.il/benefits/Vocational_Rehabilitation/Pages/default.aspx" target="_blank" className="text-right px-4 py-3 rounded-lg text-sm font-medium text-gray-500 hover:bg-gray-50 hover:text-[#005A8D] flex items-center gap-2">
                     <span>לאתר השיקום המלא</span>
