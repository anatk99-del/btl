        ...
        <div className="p-6 border-t border-gray-100 bg-gray-50 rounded-b-2xl flex justify-end gap-3 sticky bottom-0">
          ...
          {item.link && (
            <a 
              ...
              className={`px-5 py-2.5 rounded-lg text-white font-bold shadow-sm transition-transform active:scale-95 flex items-center gap-2 ${isHostage ? 'bg-amber-500 hover:bg-amber-600' : 'bg-[#005A8D] hover:bg-blue-700'}`}
            >
              <span>מעבר לאתר הרשמי</span>
